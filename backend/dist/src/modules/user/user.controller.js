...
const add_watchlist_dto_1 = require("./dto/add-watchlist.dto");
let UserController = class UserController {
    userService;
    constructor(userService) {
        this.userService = userService;
    }
    async addToWatchlist(req, addWatchlistDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, add_watchlist_dto_1.AddWatchlistDto]),
